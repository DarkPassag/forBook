...
public final class CrimeDao_Impl implements CrimeDao {
  ...
  private final CrimeTypeConvecters __crimeTypeConvecters = new CrimeTypeConvecters();
  ...
  public CrimeDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfCrime = new EntityInsertionAdapter<Crime>(__db) {
      ...
      public void bind(SupportSQLiteStatement stmt, Crime value) {
        final String _tmp;
        _tmp = __crimeTypeConvecters.fromUUID(value.getId());
        if (_tmp == null) {
          stmt.bindNull(1);
        } else {
        ...
        final Long _tmp_1;
        _tmp_1 = __crimeTypeConvecters.fromDate(value.getDate());
        if (_tmp_1 == null) {
          stmt.bindNull(3);
        } else {
    ...
    this.__updateAdapterOfCrime = new EntityDeletionOrUpdateAdapter<Crime>(__db) {
      ...
      public void bind(SupportSQLiteStatement stmt, Crime value) {
        ...
        final String _tmp_3;
        _tmp_3 = __crimeTypeConvecters.fromUUID(value.getId());
        if (_tmp_3 == null) {
          stmt.bindNull(6);
        } else {
      ...
      public List<Crime> call() throws Exception {
        ...
        try {
          ...
          while(_cursor.moveToNext()) {
            ...
            _tmpId = __crimeTypeConvecters.toUUID(_tmp);
            ...
            _tmpDate = __crimeTypeConvecters.toDate(_tmp_1);
  ...
  public LiveData<Crime> getCrime(final UUID id) {
    ...
    int _argIndex = 1;
    final String _tmp;
    _tmp = __crimeTypeConvecters.fromUUID(id);
    if (_tmp == null) {
      ...
      public Crime call() throws Exception {
        ...
        try {
          ...
          if(_cursor.moveToFirst()) {
            ...
            _tmpId = __crimeTypeConvecters.toUUID(_tmp_1);
            final String _tmpTitle;
            if (_cursor.isNull(_cursorIndexOfTitle)) {
              _tmpTitle = null;
            } else {
            ...
            _tmpDate = __crimeTypeConvecters.toDate(_tmp_2);
            final boolean _tmpIsSolved;
            final int _tmp_3;
